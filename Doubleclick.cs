...
namespace Doubleclick
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            System.Console.WriteLine("*                                                                             *");
            System.Console.WriteLine("* Doubleclick v0.0.1                                                          *");
            System.Console.WriteLine("*                                                                             *");
            System.Console.WriteLine("* Do a double mouse click.                                                    *");
            System.Console.WriteLine("*                                                                             *");
            System.Console.WriteLine("* use: Doubleclick iX iY                                                      *");
            System.Console.WriteLine("*                                                                             *");
            ...
            else
            {
                ...
                aInputs[3].type = 0; //mouse
                aInputs[3].U.mi.dx = x;
                aInputs[3].U.mi.dy = y;
                aInputs[3].U.mi.dwFlags = user32.MOUSEEVENTF.LEFTDOWN;
                aInputs[3].U.mi.time = 0;
                aInputs[3].U.mi.mouseData = 0;
                aInputs[4].type = 0; //mouse
                aInputs[4].U.mi.dx = x;
                aInputs[4].U.mi.dy = y;
                aInputs[4].U.mi.dwFlags = user32.MOUSEEVENTF.LEFTUP;
                aInputs[4].U.mi.time = 0;
                aInputs[4].U.mi.mouseData = 0;
