...
{   
    class Program
    {   
        public static String sWinClass;
        public static String sShowOption;
        public static user32.ShowWindowCommands eShowOption;
        static void Main(string[] args)
        {
            ...
            if (args.Length == 2)
            {
                ...
                for (int i = 0; i < 13; i++) if (sShowOption == aOption[i] ) eShowOption =aeOption[i];
            }
